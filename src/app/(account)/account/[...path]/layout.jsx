...
export default async function AccountPageLayout({ children, params }) {
    ...
    return (
        <>
            <section className="flex flex-col relative lg:flex-row justify-between items-start lg:block lg:space-x-5" >
                ...
                <div className='w-full !ml-0 xl:max-w-5xl lg:!ml-64 xl:!ml-72 lg:w-[calc(100%-16rem)] xl:w-[calc(100%-18rem)] pt-10 lg:pt-0 lg:px-10 '>
