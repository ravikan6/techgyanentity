    ...
    return (
        <>
            <div className="m-auto py-2 rounded-full bg-lightHead dark:bg-darkHead">
                <div className="flex items-center px-4 md:px-10 space-x-4 md:space-x-10 m-auto">
                    {tabs.map((tab, index) => {
                        ...
                        return (
                            <div key={index} className="flex items-center justify-center">
                                <Link
                                    ...
                                    className={`px-5 md:px-8 h-8 font-semibold text-sm rounded-full align-middle flex items-center ${isActive ? 'bg-lightButton dark:bg-darkButton text-black' : 'bg-light text-zinc-800 dark:bg-dark dark:text-zinc-100 dark:hover:text-darkButton hover:text-lightButton'}`}
                                >
                                    {tab.label}
                                </Link>
                            </div>
