...
<span className="hidden sm:block">Featured</span>
                            ...
                            <div className="w-full flex flex-col md:flex-row gap-3 sm:gap-4 md:gap-6 justify-between">
                                ...
                                <div className="w-full rounded-xl md:rounded-lg bg-light dark:bg-dark relative cursor-pointer md:basis-[180px] md:h-[108px] md:shrink-0">
                                            ...
                                            <div style={{ position: "absolute", top: 0, right: 0, bottom: 0, left: 0 }}>
                                                <Link className="block w-full h-full overflow-hidden rounded-xl md:rounded-lg focus:outline-none focus:ring focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 focus:dark:ring-offset-slate-800" href={`/@${post?.author?.handle || data?.author?.handle}/${post.slug}`}>
                                                    <span style={{ boxSizing: "border-box", display: "block", overflow: "hidden", width: "initial", height: "initial", background: "none", opacity: 1, border: 0, margin: 0, padding: 0, position: "absolute", top: 0, left: 0, bottom: 0, right: 0 }}>
                                                        <ArticleImage image={post?.image} className="rounded-xl" style={{ position: "absolute", inset: "0px", boxSizing: "border-box", padding: "0px", border: "none", margin: "auto", display: "block", width: "0px", height: "0px", minWidth: "100%", maxWidth: "100%", minHeight: "100%", maxHeight: "100%", objectFit: "cover" }} />
                                                    </span>
                                                </Link>
                                            </div>
                                        </div>
