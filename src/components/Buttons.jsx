...
const CreateBtn = ({ classes, iconColor, sx }) => {
  return (
    <Link href="/studio/write" className={`rounded-full justify-center cursor-pointer border border-transparent chetlnam active:border flex items-center transition-all text-sm duration-300 ${classes}`}>
